...
const scrapping = async () => {
  ...
  await page.waitForSelector(".search-item"); // Este search-item sale de la class al inspeccionar. minuto 21:00 del video web scrapping 1.mp4 del 12052023

  // vamos a guardar los datos cuando ya estan disponibles
  // Hago tres constantes para coger el titulo, la imagen y precio. Esto se coje de la web buscando las clases, id y en propiedades.
  ...
  await browser.close(); // así cerramos el navegador
};
