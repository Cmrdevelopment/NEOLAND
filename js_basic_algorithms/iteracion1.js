...
//Iteración #1.3 (1.3 Crea una variable llamada 'h' con el valor 5 y otra 'y' con el valor 10.)

const h = 5;
const y = 10;

//Iteración #1.4 (1.4 Crea una otra variable 'z' y asignale el valor de 'h' + 'y'.)
